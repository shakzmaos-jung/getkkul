...
/** 홈·각 메뉴 하단 공용 푸터. 2열 그리드(좌: 서비스 / 우: 제작자). */
      ...
      <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="mt-1 text-base font-semibold tracking-tight">겟꿀</div>
          ...
          {/* 우: 제작자 */}
          <div className="flex flex-col gap-1.5">
            <div className="text-sm font-medium">정상화</div>
            <p className="text-xs leading-relaxed text-muted-foreground">
              프로덕트 빌더 / 핀포인트 주식회사 Head of Product
            </p>
            <a
              href={REPO_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-1 inline-flex w-fit items-center gap-1.5 text-xs text-muted-foreground transition-colors hover:text-foreground"
            >
              <GithubIcon />
              레포지터리
            </a>
