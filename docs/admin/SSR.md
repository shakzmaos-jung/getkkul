...
|-----|----|-------------|----------------|---|
| REQ-DS-2/3 | AC-DS-2a/3a | theme.test | packages/ui/theme.css, theme/registry.ts | M1 |
| REQ-AU-2 | AC-AU-2a/b/c | admin-authz.test | middleware, admin_users(RLS) | M1 |
| REQ-OV-1 | AC-OV-1a/b/c | overview.test | get_admin_overview | M2 |
| REQ-PI-1 | AC-PI-1a/b/c | pipeline.test | get_pipeline_status, deliveries | M3 |
| REQ-CO-1 | AC-CO-1a/b/c | cost.test | get_cost_breakdown, pricing/llm-prices | M4 |
| REQ-GR-1 | AC-GR-1a/b | growth.test | get_growth_metrics, get_referral_progress | M5 |
| REQ-SE-1 | AC-SE-1a/b | security.test | audit/gitleaks 산출물, IDOR 체크 | M6 |
| REQ-AL-1 | AC-AL-1a/b | alerts.test | get_incident_log, 운영자 알림 | M7 |
| REQ-OP-1 | AC-OP-1a/b | ops.test | 채널/구독자 조회, 수동 실행 가드 | M8 |
